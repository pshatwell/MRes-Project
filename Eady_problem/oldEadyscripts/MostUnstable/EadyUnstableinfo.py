...
#SIGMA IS CURRENTLY THE MAXIMUM GROWTH RATE. THIS IS ONLY VALID FOR l=0. NEED TO REPLACE WITH MORE
#GENERAL DEFINITION FOR SIGMA.
...
#STILL UNSURE ABOUT THIS EXPRESSION FOR c. DON'T WE NEED TO USE EQUATION DERIVED FROM BCs??
c = U/L #phase speed, dimensions of s^(-1)

#Information to plot background theta distribution
theta0 = 300. #WHAT SHOULD THIS BE?? THIS CHANGES SLOPE OF ISENTROPES.
...
#ADDED COSINE FUNCTION IN y TO PHIPRIME (3/5/17). NEW EXPRESSIONS BENEATH OLD. OLD EXPRESSIONS HAVE NO y-DEPENDENCE.
