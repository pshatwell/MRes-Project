...
xslice = 0.5 #Define meridional plane to view trajectories in
...
p=0 #Choose parameter p to position initial cluster
...
Eadyanim.save('movies/Eadybundle_p_%s_xslice_%s.mp4' % (str(p), str(xslice)), fps=20, bitrate=-1, codec='libx264', writer='ffmpeg')
